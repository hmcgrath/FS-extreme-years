...
JUSTIFICATION_CSV_PATH =  "D:\\Research\\FS-2dot0\\results\\WetDryTrendsPaper\\supplement\\1990-2023percentile_justification.csv"  # <-- set to your justification CSV path      # has the columns you listed
RECOMMENDED_Q_CONFIG_PATH = "D:\\Research\\FS-2dot0\\results\\WetDryTrendsPaper\\supplement\\recommended_q_config.csv"  # <-- set to your justification CSV path
outpath = "D:\\Research\\FS-2dot0\\results\\WetDryTrendsPaper\\supplement"  # output figure path
...
TILE_TO_PLOT = "09AB000"          # tile_id to render in panels (a), (b), (d)
YEARS_RANGE = range(1990, 2024)   # inclusive 1990..2023
